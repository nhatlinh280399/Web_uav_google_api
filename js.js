$(function ()
{
    ...
    mapView.map = L.map(divMapId[0]).setView([21, 106], 15);
	
    var myUrl = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidmlldGFuaDEyNyIsImEiOiJja2loNDVrNmkwM2JvMnpwYnNycHI1a2lhIn0.iDWKWzii2ThXgrgp0Ef6rg';
    L.tileLayer(myUrl, { maxZoom: 40, attribution: 'Source code © <a href="https://github.com/ungvietanh20172394/ungvietanh20172394.github.io">source</a>', id: 'mapbox/streets-v11', tileSize: 512, zoomOffset: -1 }).addTo(mapView.map);
